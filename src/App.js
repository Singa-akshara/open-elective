...
function App() {
  ...
  useEffect(() => {
    ...
    const storedLoggedIn = localStorage.getItem("testLoggedin");
    if (storedLoggedIn) {
      setLoggedIn(true);
    } else {
      setLoggedIn(false);
  ...
  const logoutHandler = () => {
    ...
    localStorage.removeItem("testLoggedin"); // Remove login status from localStorage
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/courses" element={loggedIn ? <StudentPage /> : <Navigate to="/student-login" />} />
        <Route path="/student-page" element={<StudentPage />} />
        <Route path="/faculty-page" element={<FacultyPage />} />
        <Route path="/home" element={<HomePage />} />
        <Route path="/logout" element={<LogoutPage />} />
